...
- (NSData *)AES128operation:(CCOperation)operation data:(NSData *)data key:(NSString *)key iv:(NSString *)iv {
     ...
     *  ECB加密方式
     *
     *  @param operation          加解密方式
     *  @param kCCAlgorithmAES128 kCCAlgorithmAES128 description
     *  @param kCCOptionECBMode   ECB加密方式
     *  @param keyPtr             keyPtr description
     *  @param kCCKeySizeAES128   kCCKeySizeAES128 description
     *  @param NULL               NULL 为ECB
     *  @param bytes]             bytes] description
     *  @param length]            length] description
     *  @param buffer             buffer description
     *  @param bufferSize         bufferSize description
     *  @param numBytesEncrypted  numBytesEncrypted description
     *
...
//                                            &numBytesEncrypted);
     ...
     *
     *  @param operation              加解密方式
     *  @param kCCAlgorithmAES128    kCCAlgorithmAES128
     *  @param kCCOptionPKCS7Padding kCCOptionPKCS7Padding
     *  @param keyPtr                keyPtr
     *  @param kCCKeySizeAES128      kCCKeySizeAES128
     *  @param iv                    秘钥偏移量
     *  @param bytes]                bytes]
     *  @param length]               length]
     *  @param buffer                buffer
     *  @param bufferSize            bufferSize
     *  @param numBytesEncrypted     numBytesEncrypted
     *
     *  @return return value
     */
